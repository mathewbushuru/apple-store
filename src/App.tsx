...
export default function App() {
  return (
    <main className="pb-20">
      ...
      {/* Product cards  */}
      <div className="">
        <p className="p-4 pb-8 text-2xl font-semibold tracking-wide text-zinc-500 sm:px-8 sm:text-3xl sm:leading-[1.10] xl:px-32">
          <span className="text-foreground">The latest. </span>
          Take a look at what's new, right now.
        </p>

        <div className="scrollbar-hide flex gap-4 overflow-x-auto p-4 sm:p-8 xl:gap-6 xl:pl-32">
          ...
          <div className="relative min-w-fit cursor-pointer">
            <img
              ...
              className="h-[450px] w-[300px] rounded-2xl object-cover shadow-md transition-all duration-300 hover:scale-[1.02] hover:shadow-lg sm:h-[500px] sm:w-[400px]"
            />
            <div className="absolute top-[10%] px-8 text-foregound xl:space-y-2">
              <p className="text-xl font-semibold xl:text-3xl">Apple Vision Pro</p>
          ...
          <div className="relative min-w-fit cursor-pointer">
            ...
            <div className="absolute top-[10%] px-8 text-foreground xl:space-y-2">
              ...
              <p className="mb-1 font-semibold">Mind-blowing.<br/>Head-turning.</p>
